...
export const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose, source = 'modal' }) => {
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        style={{ zIndex: 10000 }}
                    >
                        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-2xl max-h-full overflow-hidden flex flex-col">
