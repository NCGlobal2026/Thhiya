 ...
 */
router.get('/submissions', requireAuth, requireAdmin, (c: any) => bantController.list(c));
/**
 * @route   GET /api/bant/submissions/stats
 * @desc    Get submission statistics
 * @access  Private (Admin)
 */
router.get('/submissions/stats', requireAuth, requireAdmin, (c: any) => bantController.getStats(c));
/**
 * @route   GET /api/bant/submissions/:id
 * @desc    Get a single submission by ID
 * @access  Private (Admin)
 */
router.get('/submissions/:id', requireAuth, requireAdmin, (c: any) => bantController.getById(c));
/**
 * @route   PATCH /api/bant/submissions/:id
 * @desc    Update a submission (status, notes, etc.)
 * @access  Private (Admin)
 */
router.patch('/submissions/:id', requireAuth, requireAdmin, (c: any) => bantController.update(c));
/**
 * @route   DELETE /api/bant/submissions/:id
 * @desc    Delete a submission
 * @access  Private (Admin)
 */
router.delete('/submissions/:id', requireAuth, requireAdmin, (c: any) => bantController.delete(c));
